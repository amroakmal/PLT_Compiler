...
namespace PLT
{
    public partial class FollowSetsForm : Form
    {
        public FollowSetsForm()
        {
            InitializeComponent();
        }

        private void FollowSetsForm_Load(object sender, EventArgs e)
        {
            var dataTable = ConvertCSVtoDataTable("follow.txt");
