...
namespace PLT
{
    public partial class LinesTypesForm : Form
    {
        public LinesTypesForm()
        {
            InitializeComponent();
        }

        private void LinesTypesForm_Load(object sender, EventArgs e)
        {
            var dataTable = ConvertCSVtoDataTable("lines-types.txt");
