...
namespace PLT
{
    public partial class FirstSetsForm : Form
    {
        public FirstSetsForm()
        {
            InitializeComponent();
        }

        private void FirstSetsForm_Load(object sender, EventArgs e)
        {
            var dataTable = ConvertCSVtoDataTable("first.txt");
